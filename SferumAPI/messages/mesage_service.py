...
class MessageService:
    ...
    def mark_as_read(self, peer_id: int):
        try:
            url = "https://api.vk.me/method/messages.markAsRead?v=5.241"
    ...
    def execution_vkscript(self, script: str) -> dict:
        try:
            url = 'https://api.vk.me/method/execute?v=5.241'
